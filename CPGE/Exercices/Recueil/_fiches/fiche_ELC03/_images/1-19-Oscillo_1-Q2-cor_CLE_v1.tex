...
\begin{tikzpicture}[scale=0.45]
	%ecran oscilloscope
	\draw[black,thick,rounded corners=10pt] (0,0) rectangle (10,8) (0.5,-1.3) node[right]{\textcolor{Black}{\scriptsize{Calibre vertical : 2 V/division}}}
	 ;
	\begin{scope} % permet d'appliquer des propriétés à une partie de code seulement
		...
		%legende
		\draw[color=gray!80,line width=1pt,<->,>=stealth] (3,1) -- (3,7) node [midway, left] {\colorbox{white}{\textcolor{gray}{\scriptsize{$2.U_0$}}}} node [midway, right] {\colorbox{white}{\textcolor{gray}{\scriptsize{6 carreaux}}}} ;
