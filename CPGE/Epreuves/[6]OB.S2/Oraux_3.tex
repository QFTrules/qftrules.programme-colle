...
\clearpage
\begin{oral}[2]
  \ExoMines[bilans]{Écoulement d'un dôme de lave}
  \Ex[ondescond]{Observation d'un pulsar}
\end{oral}


\clearpage
\begin{oral}[1]
  \Principal*[geometrique]{Théorie de Descartes de l'arc-en-ciel}
...
\clearpage
\begin{oral}[2]
  \ExoCentrale[optique]{Épaisseur du cellophane}
\end{oral}
