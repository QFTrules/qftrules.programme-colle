  ...
  \draw [<->,thick] (0,-2.5) -- node[below] {$D$} (10,-2.5)  ; %Repérage Distance D
  
  \draw [<->,thick] (1.5,-2) -- node[above] {$d$} (6.5,-2)  ; %Repérage Distance d
  
  \node at (1.5,2.2) {Position 1}  ; %Légende1
  \node at (6.5,2.2) {Position 2}  ; %Légende1 
  \node at (10,2.2) {Écran}  ; %Légende1
