...
\begin{tikzpicture}[scale=2.0]
  ...
  % AXES
  \draw[->,thick] (0,-\ymin) -- (T) node[above=0] {temps};
  \draw[->,thick] (-\xmin,0) -- (\xmax+0.2,0) node[right=0] {espace};
  \def\psia{63}
  ...
  \draw[photon,shorten >=1] (O) -- (45:1.08*\xmax)
  ...
  \coordinate (E) at (\xe,{\xe*3});  
  \node at (E) [mydarkpurple] {$\bullet$};
  \node at (E) [above=3,mydarkpurple] {\contour{white}{$E$}};
  \draw[dashed] (E) --  (\xe,0) node [below] {\contour{white}{$x$}};
  \draw[dashed] (E) -- (0,{\xe*3}) node [left] {\contour{white}{$t$}};
