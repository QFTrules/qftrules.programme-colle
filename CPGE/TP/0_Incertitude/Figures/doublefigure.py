...
def figsize(scale):                                 # Define default ratio
    ...
    fig_width = fig_width_pt*inches_per_pt*scale/golden_mean*5/4   # Width in inches
    fig_height = fig_width_pt*inches_per_pt*scale/golden_mean      # Height in inches
...
# fit_affine() realise un ajustement affine des donnes avec incertitudes
def fit_affine(x,y,dx,dy):
...
# fit_linear() realise un ajustement lineaire des donnes avec incertitudes
def fit_linear(x,y,dx,dy):
