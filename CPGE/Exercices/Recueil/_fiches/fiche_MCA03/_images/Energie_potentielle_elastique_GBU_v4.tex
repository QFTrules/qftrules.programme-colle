...
\fill (-3,-3.5) circle(.1) node[right, xshift=1.5mm]{$\ptM$};
\end{scope}
...
\fill (5.5,-2.75) circle(.1) node[below right]{$\ptM$};
...
\fill (-4.5,-7.7) circle(0.1);
\draw (-7,-7) -- (-7,-8) -- (-1,-8) -- (-1,-7);
\draw[decoration={aspect=0.3, segment length=1.1mm, amplitude=2mm,coil},decorate] (-6.8,-7.7) -- (-4.7,-7.7);
\draw (-7,-7.7) -- (-6.8,-7.7)
	  (-4.7,-7.7) -- (-4.3,-7.7);
\draw[decoration={aspect=0.3, segment length=1.5mm, amplitude=2mm,coil},decorate] (-1.1,-7.7) -- (-4.3,-7.7);
\draw (-1,-7.7) -- (-1.1,-7.7);
