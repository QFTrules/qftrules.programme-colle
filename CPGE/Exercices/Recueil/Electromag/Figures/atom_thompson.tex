...
\begin{tikzpicture}[scale=1]
  ...
  \draw[mydarkblue,thick] (O) circle (50pt) node[above right=34pt] {$+e$};
  \fill[radius=2pt,mydarkred]
    % ( 0.20, 1.20)  circle node[above right=-1pt] {$-e$}
    % ( 0.10, 0.30)  circle node[above right=-1pt] {$-e$}
    % ( 0.68, 0.67)  circle node[above right=-1pt] {$-e$}
    % ( 1.05,-1.10)  circle node[above left =-1pt] {$-e$}
    % ( 0.75,-0.12)  circle node[      right= 2pt] {$-e$}
    % ( 0.21,-1.30)  circle node[above left =-1pt] {$-e$}
    % ( 0.18,-0.55)  circle node[above left =-1pt] {$-e$}
    % (-0.80, 0.60)  circle node[above left =-1pt] {$-e$}
    % (-0.50, 1.21)  circle node[above right=-1pt] {$-e$}
    % (-0.40, 0.05)  circle node[above left =-1pt] {$-e$}
    % (-0.58,-0.95)  circle node[above left =-1pt] {$-e$}
    (-1.10,-0.20)  circle node[above left =-1pt] {$-e$};

    % distance r 
    \draw[<->,>=latex] (-0.05,-0.02) -- ( -1.05,-0.20) node[midway,below] {$r$};
    % center O
    \fill[radius=2.0pt,black] (O) circle node[above=2pt] {O};
\end{tikzpicture}
