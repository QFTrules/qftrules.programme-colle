...
class FresnelC1(Scene):
    def construct(self):
        ...
        vector2 = Arrow(start=vector1.get_end(), end=[2, 2, 0], buff=0, color=RED)
        ...
        self.add(axes, sum_vector, vector1_group, vector2_group)
        ...
        self.play(
            ...
            UpdateFromFunc(vector2_label, lambda m: m.next_to(vector2.get_end(), 0.5 * vector2.get_unit_vector()))
        )
