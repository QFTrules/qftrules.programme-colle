...
\begin{tikzpicture}[scale=2.0]
  ...
  \coordinate (E) at (\xe,{\xe*tan(\psia)});  
  \node at (E) [mydarkpurple] {$\bullet$};
  \node at (E) [above=3,mydarkpurple] {$E$};
  \draw[dashed] (E) --  (\xe,0) node [below] {$x$};
  \draw[dashed] (E) -- (0,{\xe*tan(\psia)}) node [left] {$t$};
