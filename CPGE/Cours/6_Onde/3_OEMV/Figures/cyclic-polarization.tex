...
\newcommand{\plane}[2]{%
	...
	\begin{scope}[canvas is yz plane at x=#1]
		...
		\draw[thick, fill=black!10, dashed] (0,0) ellipse (0.75cm and 0.75cm);
	\end{scope}
}
...
%	\draw[->] (0,0,0) -- (0,0,2) node[above] {$z$};
	...
	\draw[very thick, ->] (1,0,0) -- (8.3,0,0) node[right, black] {$z$};
	...
	\draw[axis] (6,0,0) -- ++(0,0,1.5) node[above, black] {$y$};
	\draw[axis] (6,0,0) -- ++(0,1.5,0) node[right, black] {$x$};
