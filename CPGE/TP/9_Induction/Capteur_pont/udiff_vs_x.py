...
(a0, a_err, b0, b_err, chi2) = fit_affine(x[i:],     #abscisse
                                          u[i:],     #ordonnee
                                          herr[i:], #incertitude abscisse
                                          Cerr[i:]) #incertitude ordonnee
