...
\begin{tikzpicture}[scale=1.3]
  ...
  % LABELS
  % \draw[->,very thick,orange!90!black] (\x,0.5*\Rb) node[left,orange!90!black] {$p$} --++ (0.2*\L,0);
    \draw[<-,very thick,orange!90!black] (\x,0) --++ (0.2*\L,0) node[right,orange!90!black] {$Q$};
  ...
  % GAS PARTICLE
  \pic at (-0.12*\x, 0.2*\Rb) {gasparticle={vec={ -40:0.3*\v}}};
  \pic at (-0.07*\x,-0.5*\Rb) {gasparticle={vec={  48:0.35*\v}}};
  \pic at ( 0.00*\x, 0.3*\Rb) {gasparticle={vec={ 105:0.3*\v}}};
  \pic at ( 0.05*\x,-0.5*\Rb) {gasparticle={vec={-100:0.35*\v}}};
  \pic at ( 0.08*\x, 0.0*\Rb) {gasparticle={vec={  70:0.5*\v}}};
  \pic at ( 0.07*\x, 0.7*\Rb) {gasparticle={vec={ -10:0.45*\v}}};
  \pic at ( 0.15*\x,-0.2*\Rb) {gasparticle={vec={  30:0.45*\v}}};
  \pic at ( 0.20*\x,-0.8*\Rb) {gasparticle={vec={ -10:0.35*\v}}};
  \pic at ( 0.35*\x, 0.6*\Rb) {gasparticle={vec={-110:0.5*\v}}};
  \pic at ( 0.35*\x,-0.6*\Rb) {gasparticle={vec={ 140:0.6*\v}}};
  \pic at ( 0.40*\x, 0.9*\Rb) {gasparticle={vec={ -40:0.55*\v}}};
  \pic at ( 0.43*\x,-0.2*\Rb) {gasparticle={vec={  75:0.65*\v}}};
  \pic at ( 0.50*\x, 0.5*\Rb) {gasparticle={vec={-170:0.7*\v}}};
  \pic at ( 0.52*\x,-0.7*\Rb) {gasparticle={vec={ 120:0.85*\v}}};
  \pic at ( 0.60*\x, 0.4*\Rb) {gasparticle={vec={ -80:0.8*\v}}};
  \pic at ( 0.63*\x,-0.6*\Rb) {gasparticle={vec={  42:0.95*\v}}};
  \pic at ( 0.65*\x,-0.2*\Rb) {gasparticle={vec={ 150:0.9*\v}}};
  \pic at ( 0.68*\x,-0.8*\Rb) {gasparticle={vec={ 190:0.85*\v}}};
  \pic at ( 0.72*\x, 0.8*\Rb) {gasparticle={vec={ 160:1*\v}}};
  \pic at ( 0.72*\x, 0.3*\Rb) {gasparticle={vec={  80:1.05*\v}}};

  \draw[<->,white] (0.3*\x,-1.2*\Rb) --++ (0.5*\x,0) node[midway,below] {$\Delta x$};
\end{tikzpicture}
\end{document}
