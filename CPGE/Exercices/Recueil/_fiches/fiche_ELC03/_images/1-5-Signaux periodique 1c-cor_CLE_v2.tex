...
\begin{tikzpicture}[scale=0.45]
	...
	\begin{scope} % permet d'appliquer des propriétés à une partie de code seulement
		\clip (-2,0.05) rectangle (12,8.5);%créer une découpe de la fenêtre comme indiqué
		...
		\draw[color=gray!80,line width=1pt,->,>=stealth] (0,3.5) -- (10.5,3.5) node [right] {\colorbox{white}{\textcolor{gray}{\scriptsize{$t$}}}} ;
		\draw[color=gray!80,line width=1pt] (3.5,3.2) -- (3.5,3.7) node [below] {\colorbox{white}{\textcolor{gray}{\scriptsize{$t_1$}}}} ;
