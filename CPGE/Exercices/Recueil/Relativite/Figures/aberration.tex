...
\def\axes{
  ...
  % AXES
  \draw[->,thick] (0,-\xmin) -- (T) node[above] {$y$};
...
% \draw[myblue,dashed,rounded corners=0.1]
  ...
  \draw[black,dashed,rounded corners=0.1]
     (D)   -- (0,0);
  \draw[->] (0.5*\dt,1.333*\dt) arc(180:180+50:0.5*\dt) node[midway,left] {\contour{white}{$\theta$}};
  ...
  \draw[mydarkblue,very thick,->] (C) -- ++(-0.8,0) node[midway,above] {\contour{white}{$-u$}};
