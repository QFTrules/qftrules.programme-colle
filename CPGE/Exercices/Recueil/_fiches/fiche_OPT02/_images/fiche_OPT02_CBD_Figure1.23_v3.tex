  \begin{tikzpicture}[scale=0.82]
    ...
    \filldraw [black] (10,0) circle (2pt) node [above right] {$\ptO_2$} ;  %Le centre optique de L2
    \filldraw [black] (8.0,0) circle (2pt) node at (8,0.8) {$\ptF_2$} ; %Le foyer objet de L2
    \filldraw [black] (12.0,0) circle (2pt) node at (12,0.75) {$\ptF'_2$} ; %Le foyer image de L2
   ...
   \draw [->,thin] (13,0.75) -- (14,1.25) ; %% Direction image B'
   ...
   \draw [->,thin] (13,-0.25) -- (14,-0.25) ; %% Direction image A'
